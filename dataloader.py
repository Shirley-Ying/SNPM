...
class PoiDataloader():
    ...
    def __init__(self, max_users,min_checkins,work_length,Userdata,usercount,locscount,freqtimedata):
        ...
        #################################################################################
        self.users=Userdata[:,0]
        self.times=Userdata[:,1]
        self.time_slots=Userdata[:,2]
        self.coords=Userdata[:,3]
        self.locs=Userdata[:,4]

        self.freqtimedata=freqtimedata

        self.usercount=usercount
        self.locscount=locscount
        #################################################################################
